...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, PurchaseRequest> userConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PurchaseRequest> userKafkaListenerFactory() {
